...
app.use(session({secret:'Key',saveUninitialized: false, resave: false,  store: new MongoStore({
  mongoUrl: 'mongodb://127.0.0.1:27017/e-commerce',
  collection: 'sessions', // name of the sessions collection (optional)
  ttl: 60 * 60 // session expiration time in seconds (optional)
})}))
